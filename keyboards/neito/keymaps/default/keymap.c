...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DEFAULT] = LAYOUT(
        ...
        KC_ESC, KC_A,            KC_S, KC_D, KC_F, KC_G,                    KC_H, KC_J, KC_K, KC_L,                          KC_SCLN, KC_QUOT, KC_NUHS,           KC_END,  
        KC_LSFT, KC_NUBS, KC_Z,   KC_X, KC_C, KC_V, KC_B,              KC_B, KC_N, KC_M, KC_COMM, KC_DOT,                       KC_SLSH, KC_RSFT,         KC_UP, 
        KC_LCTL,     KC_LGUI,     KC_LALT, KC_SPC,                       KC_BSPC, KC_RALT,        KC_RCTL,                                            KC_LEFT, KC_DOWN,  KC_RGHT
    ),
    [_FN0] = LAYOUT(
